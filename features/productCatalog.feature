Feature: Product Catalog
  ...
  Scenario: View Categories
    Given the user is loged in and on product catalog page
  ...
  Scenario: View Product Listings
    Given the user is loged in and on a category page
  ...
  Scenario: Search and Filter Products
    Given the user is loged in and on the product catalog page
    When the user searches for a product with product name
    Then the user should see filterd product listings